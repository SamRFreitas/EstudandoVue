<template>
	<div id="app" class="container-fluid">
		...
		<transition :name="tipoAnimação" mode="out-in">
			<b-alert variant="success" show v-if="exibir" key="info">{{ msgWarning }}</b-alert>
			<b-alert variant="warning" show v-else key="warn">{{ msgWarning }}</b-alert>
		</transition>
...
export default {
	...
	data() {
		return {
			alunos: ['Roberto', 'Tereza', 'Paula', 'Julia'],
			msgInfo: 'Uma mensagem e informação para o usuário - Info',
			msgWarning: 'Uma mensagem e informação para o usuário - Warning ',
			exibir: false,
			exibir2: true,
			tipoAnimação: 'fade',
			larguraBase: 0,
